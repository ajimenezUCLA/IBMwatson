...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-piv8klqdgup">Show
  modal</button>

<div data-modal id="modal-piv8klqdgup" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-piv8klqdgup-label" aria-describedby="modal-piv8klqdgup-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-piv8klqdgup-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-piv8klqdgup-heading">Modal heading</p>
