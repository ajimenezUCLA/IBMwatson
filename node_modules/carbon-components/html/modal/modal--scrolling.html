...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-6fic92qd8tb">Show
  modal</button>

<div data-modal id="modal-6fic92qd8tb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-6fic92qd8tb-label" aria-describedby="modal-6fic92qd8tb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-6fic92qd8tb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-6fic92qd8tb-heading">Modal heading</p>
