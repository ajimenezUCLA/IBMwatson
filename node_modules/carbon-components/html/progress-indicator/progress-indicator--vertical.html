...
<ul data-progress data-progress-current class="bx--progress bx--progress--vertical">
    ...
    <li class="bx--progress-step bx--progress-step--current "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltiph49rxgu6l7n">
            Second Step
      </p>
      <div id="label-tooltiph49rxgu6l7n" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
    ...
    <li class="bx--progress-step bx--progress-step--incomplete "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltiple3pdxzra0q">
            Third Step
      </p>
      <div id="label-tooltiple3pdxzra0q" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
