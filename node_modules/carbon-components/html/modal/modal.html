...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wq5sc7lrwyo">Show
  modal</button>

<div data-modal id="modal-wq5sc7lrwyo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wq5sc7lrwyo-label" aria-describedby="modal-wq5sc7lrwyo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wq5sc7lrwyo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wq5sc7lrwyo-heading">Modal heading</p>
