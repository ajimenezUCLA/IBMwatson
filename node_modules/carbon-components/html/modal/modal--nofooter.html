...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fmbdadkt1ak">Show
  modal</button>

<div data-modal id="modal-fmbdadkt1ak" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fmbdadkt1ak-label" aria-describedby="modal-fmbdadkt1ak-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fmbdadkt1ak-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fmbdadkt1ak-heading">Modal heading</p>
